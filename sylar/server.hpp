...
public:
    ...
    TcpServer(sylar::IOmanager* worker = dynamic_cast<sylar::IOmanager*>(sylar::IOmanager::GetThis())
              ,sylar::IOmanager* io_woker = dynamic_cast<sylar::IOmanager*>(sylar::IOmanager::GetThis())
              ,sylar::IOmanager* accept_worker = dynamic_cast<sylar::IOmanager*>(sylar::IOmanager::GetThis()));
    virtual ~TcpServer();
